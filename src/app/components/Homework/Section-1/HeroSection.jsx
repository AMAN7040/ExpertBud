...
const HeroSection = () => {
  return (
    <section className="relative bg-[url('/HeroSection_bg.png')] bg-cover h-[calc(100vh-70px)] flex flex-col md:flex-row md:justify-evenly  items-center">
      ...
      <div className="relative h-70 sm:w-[50vw] w-80 md:w-1/3 md:h-1/2 lg:w-1/3 lg:h-[609px]"> 
        <BusinessSec/>
      </div>
